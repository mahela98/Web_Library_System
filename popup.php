...
<button type="button" class="changepw" data-toggle="modal" data-target="#Modal1" >Change Password</button>

<div class="modal fade" 
style="background-color: rgba(0, 0, 0, 0.699);"
id="Modal1" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
